...
class Document(models.Model):
    ...
    results = models.TextField(
        ...
        max_length=500,
        blank=True)
    download_status = models.SmallIntegerField(
        'ダウンロード状態',
        choices=DOWNLOAD_STATUS_CHOICE,
        default=1,
        help_text='ダウンロード可否')
...
class DocumentDownloadLog(models.Model):
    ...
    document_id = models.IntegerField(
        verbose_name='資料ID', null=True, blank=True)
